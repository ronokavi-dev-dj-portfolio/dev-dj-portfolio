...
3. Verify navigation, external links, hover and focus states, media loading, and any motion.
4. Look for horizontal overflow, clipped text, layout shifts, unreadable contrast, and overlapping content.
5. Confirm `prefers-reduced-motion` behavior when animation exists.
6. Record failures with the viewport, route, reproduction steps, and expected result.
